...
class Message(models.Model):
    ...
    sender = models.ForeignKey('UserProfile', on_delete=models.CASCADE, related_name='fk_message_sender')
    recipient = models.ForeignKey(
        'UserProfile', on_delete=models.CASCADE, related_name='fk_message_recipient')
